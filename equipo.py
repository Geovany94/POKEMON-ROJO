class Equipo:
    ...
    def equipo_poke(self, id, nombre, apodo, xp, tipo, movimientos, nombre_stat ,stat):
        self.id = id
        self.nombre = nombre
        self.apodo = apodo
        self.xp = xp
        ...
        #Datos de combate
        self.nombre_stat = nombre_stat
        self.stat = stat

    def ver_pokemon(self):
        pass

    def generar_poke_rival(self, id, nombre, xp, tipo, movimientos, nombre_stat ,stat):
        self.id_rival = id
        ...
        #Datos de combate
        self.nombre_stat_rival = nombre_stat
